	...
	public static void main(String[] args) {
		...
		while (playerHealth > 0 && dragonHealth > 0) { // this line of code keeps the battle going until someone's
			...
			String answer = JOptionPane.showInputDialog(null,
					"Would you like to attack the dragon with a yell or a kick?");
			// 9. If they typed in "yell":
			if (answer.equals("yell")) {
				dragonDamage = new Random().nextInt(501);
			...
			// 10. If they typed in "kick":
				...
				dragonDamage = new Random().nextInt(1001);
				dragonHealth = dragonHealth - dragonDamage;
			}
			...
			// 14. Else if the dragon's health is less than or equal to 0
            	  ...
            	  JOptionPane.showMessageDialog(null, "The Dragon is dead!! Your reward is a ton of gold!");
              }
